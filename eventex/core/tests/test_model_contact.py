...
class ContactModelTest(TestCase):
    ...
    def test_phone(self):
        contact = Contact.objects.create(speaker=self.speaker, kind=Contact.PHONE, value='84-991234567')
...
class ContactManagerTest(TestCase):
    def setUp(self):
        ...
        s.contact_set.create(kind=Contact.PHONE, value='84-988929399')
